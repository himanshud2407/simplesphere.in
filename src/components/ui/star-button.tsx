  ...
  return (
    <button
      className="
        ...
        rounded-xl 
        shadow-[0_0_0_rgba(37,99,235,0.4)] 
        transition-all duration-300 ease-in-out 
        cursor-pointer
        hover:bg-transparent hover:text-[#2563eb] hover:shadow-[0_0_25px_rgba(37,99,235,0.4)]
        active:scale-95
      "
    >
      Get Started
      ...
      <div
        className="
          ...
          group-hover:drop-shadow-[0_0_10px_rgba(37,99,235,0.8)] group-hover:z-[2]
        "
      >
        <Star />
      </div>
